    ...
    return (
        <>
            <div className="flex h-screen w-full">
                {/* Start SideBar */}
                <aside className="w-20 relative z-20 flex-shrink-0 px-2 overflow-y-auto sm:block">
                    <div className="mb-6">
                    {/* Start logo */}
                ...
                {/* Start Open Menu */}
                <aside                    
                    className={`${isActive ? 'sm:none' : 'sm:block'} animate__animated animate__fadeInLeft w-52 relative z-0 flex-shrink-0 hidden px-4 overflow-y-auto`}
                >
                    <div className="mb-6">
                    {/* Start Sidebar for open menu */}
                    <div className="grid grid-cols-1 gap-4 grid-cols-2 mt-6">
                        {/* Start Navitem */}
                        <div className="p-2 flex flex-col items-center rounded-md justify-center shadow-xl cursor-pointer">
                        ...
                        <p className="text-xs mt-1 text-center font-semibold">Calculadora</p>
                        </div>
                        {/* ... */}
                    </div>
                    ...
                    <div className="grid pb-10 mt-4">
                        ...
                        <div className="grid grid-cols-1 gap-2 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 mt-3">
                            ...
                            <div className="relative w-full h-full px-4 sm:px-6 lg:px-4 flex items-center justify-center">
                                <div>
                                <h3 className="text-center text-white text-lg">Total Balance</h3>
                                <h3 className="text-center text-white text-3xl mt-2 font-bold">RM 27,580</h3>
